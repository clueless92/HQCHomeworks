namespace Pr01ReformatCode
{
    ...
    public class Event_reformatted : IComparable
    {
        public DateTime date;
        public String title;
        public String location;

        public Event_reformatted(DateTime date, String title, String location)
        {
            this.date = date;
            this.title = title;
        ...
        {
            Event_reformatted other = obj as Event_reformatted;
            ...
            if (byDate == 0)
            {
                ...
                return byTitle; //else is redundant
            }

            return byDate; //else is redundant
        }
    ...
    public class Program
    {
        ...
        class EventHolder
        {
            MultiDictionary<string, Event_reformatted> byTitle = new MultiDictionary<string,Event_reformatted>(true);
            OrderedBag<Event_reformatted>byDate = new OrderedBag<Event_reformatted>();
            ...
            {
                OrderedBag<Event_reformatted>.ViewEventsToShow =
                    byDate.RangeFrom(new Event_reformatted(date, "", ""), true);
                int showed = 0;
